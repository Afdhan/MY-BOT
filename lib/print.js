...
module.exports = async function (m, conn = {user: {}}) {
  ...
  console.log(`
${chalk.redBright(chalk.bgWhite('%s'))}
${chalk.cyan(chalk.bgBlackBright('%s'))}
${chalk.green('Size ' + '%s/%s %sB]')}
${chalk.cyan(chalk.bgBlackBright('%s'))} 
${chalk.blueBright('to >')} ${chalk.cyan(chalk.bgBlackBright('%s'))} 
${chalk.black(chalk.bgMagentaBright('Type ' + '%s'))}
`.trim(),
    me + '|' + conn.user.name,
