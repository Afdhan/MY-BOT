   ...
   try {
    /*var imgBB = require('imgbb-uploader')
       if ((isMedia && !m.message.videoMessage || isQuotedImage) && args.length == 0) {
        ...
        let link = 'https://api.lolhuman.xyz/api/memegen?apikey=' + api + '&texttop=' + txt1 + '&textbottom=' + txt2 + '&img=' + url;
        let meme = await fetch('https://api.lolhuman.xyz/api/memegen?apikey=' + api + '&texttop=' + txt1 + '&textbottom=' + txt2 + '&img=' + encodeURIComponent(url));
